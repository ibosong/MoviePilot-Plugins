...
class ServerChanMsg(_PluginBase):
    ...
    plugin_version = "1.0"
    # 插件作者
    plugin_author = "ibosong"
    # 作者主页
    author_url = "https://github.com/ibosong"
    # 插件配置项ID前缀
    ...
    def send(self, event: Event):
        ...
        try:
            ...
            if res and res.status_code == 200:
                ...
                logger.warn("ServerChan消息发送失败，未获取到返回信息")
        except Exception as msg_e:
            logger.error(f"ServerChan消息发送异常，{str(msg_e)}")
